 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rt=new rc("@firebase/app"),w_="@firebase/app-compat",A_="@firebase/analytics-compat",v_="@firebase/analytics",I_="@firebase/app-check-compat",S_="@firebase/app-check",R_="@firebase/auth",P_="@firebase/auth-compat",C_="@firebase/database",k_="@firebase/data-connect",x_="@firebase/database-compat",D_="@firebase/functions",O_="@firebase/functions-compat",N_="@firebase/installations",L_="@firebase/installations-compat",M_="@firebase/messaging",V_="@firebase/messaging-compat",F_="@firebase/performance",U_="@firebase/performance-compat",j_="@firebase/remote-config",B_="@firebase/remote-config-compat",G_="@firebase/storage",H_="@firebase/storage-compat",q_="@firebase/firestore",z_="@firebase/ai",K_="@firebase/firestore-compat",W_="firebase",$_="12.3.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zi=new Map,Y_=new Map,Oa=new Map;function vu(s,e){try{s.container.addComponent(e)}catch(t){Rt.debug(`Component ${e.name} failed to register with FirebaseApp ${s.name}`,t)}}function cs(s){const e=s.name;if(Oa.has(e))return Rt.debug(`There were multiple attempts to register component ${e}.`),!1;Oa.set(e,s);for(const t of zi.values())vu(t,s);for(const t of Y_.values())vu(t,s);return!0}function oc(s,e){const t=s.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),s.container.getProvider(e)}function Xe(s){return s==null?!1:s.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _s=$_;function Vd(s,e={}){let t=s;typeof e!="object"&&(e={name:e});const n={name:Da,automaticDataCollectionEnabled:!0,...e},r=n.name;if(typeof r!="string"||!r)throw Yt.create("bad-app-name",{appName:String(r)});if(t||(t=xd()),!t)throw Yt.create("no-options");const i=zi.get(r);if(i){if(kn(t,i.options)&&kn(n,i.config))return i;throw Yt.create("duplicate-app",{appName:r})}const o=new r_(r);for(const l of Oa.values())o.addComponent(l);const c=new J_(t,n,o);return zi.set(r,c),c}function Fd(s=Da){const e=zi.get(s);if(!e&&s===Da&&xd())return Vd();if(!e)throw Yt.create("no-app",{appName:s});return e}function Xt(s,e,t){let n=Q_[s]??s;t&&(n+=`-${t}`);const r=n.match(/\s|\//),i=e.match(/\s|\//);if(r||i){const o=[`Unable to register library "${n}" with version "${e}":`];r&&o.push(`library name "${n}" contains illegal characters (whitespace or "/")`),r&&i&&o.push("and"),i&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Rt.warn(o.join(" "));return}cs(new xn(`${n}-version`,()=>({library:n,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z_="firebase-heartbeat-database",ey=1,Er="firebase-heartbeat-store";let ba=null;function Ud(){return ba||(ba=b_(Z_,ey,{upgrade:(s,e)=>{switch(e){case 0:try{s.createObjectStore(Er)}catch(t){console.warn(t)}}}}).catch(s=>{throw Yt.create("idb-open",{originalErrorMessage:s.message})})),ba}async function ty(s){try{const t=(await Ud()).transaction(Er),n=await t.objectStore(Er).get(jd(s));return await t.done,n}catch(e){if(e instanceof Dt)Rt.warn(e.message);else{const t=Yt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Rt.warn(t.message)}}}async function Iu(s,e){try{const n=(await Ud()).transaction(Er,"readwrite");await n.objectStore(Er).put(e,jd(s)),await n.done}catch(t){if(t instanceof Dt)Rt.warn(t.message);else{const n=Yt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Rt.warn(n.message)}}}function jd(s){return`${s.name}!${s.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cy(s){cs(new xn("platform-logger",e=>new E_(e),"PRIVATE")),cs(new xn("heartbeat",e=>new ry(e),"PRIVATE")),Xt(xa,Au,s),Xt(xa,Au,"esm2020"),Xt("fire-js","")}cy("");var ly="firebase",uy="12.3.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tr=-1;function wy(s,e){const t=s.toTimestamp().seconds,n=s.toTimestamp().nanoseconds+1,r=z.fromTimestamp(n===1e9?new le(t+1,0):new le(t,n));return new nn(r,B.empty(),e)}function Ay(s){return new nn(s.readTime,s.key,Tr)}class nn{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new nn(z.min(),B.empty(),Tr)}static max(){return new nn(z.max(),B.empty(),Tr)}}function vy(s,e){let t=s.readTime.compareTo(e.readTime);return t!==0?t:(t=B.comparator(s.documentKey,e.documentKey),t!==0?t:J(s.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fe{constructor(e){this.value=e}static empty(){return new Fe({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!ki(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=hr(t)}setAll(e){let t=Oe.emptyPath(),n={},r=[];e.forEach((o,c)=>{if(!t.isImmediateParentOf(c)){const l=this.getFieldsMap(t);this.applyChanges(l,n,r),n={},r=[],t=c.popLast()}o?n[c.lastSegment()]=hr(o):r.push(c.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,n,r)}delete(e){const t=this.field(e.popLast());ki(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return gt(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let r=t.mapValue.fields[e.get(n)];ki(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=r),t=r}return t.mapValue.fields}applyChanges(e,t,n){un(t,(r,i)=>e[r]=i);for(const r of n)delete e[r]}clone(){return new Fe(hr(this.value))}}function af(s){const e=[];return un(s.fields,(t,n)=>{const r=new Oe([t]);if(ki(n)){const i=af(n.mapValue).fields;if(i.length===0)e.push(r);else for(const o of i)e.push(r.child(o))}else e.push(r)}),new ze(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qi{constructor(e,t){this.position=e,this.inclusive=t}}function zu(s,e,t){let n=0;for(let r=0;r<s.position.length;r++){const i=e[r],o=s.position[r];if(i.field.isKeyField()?n=B.comparator(B.fromName(o.referenceValue),t.key):n=hs(o,t.data.field(i.field)),i.dir==="desc"&&(n*=-1),n!==0)break}return n}function Ku(s,e){if(s===null)return e===null;if(e===null||s.inclusive!==e.inclusive||s.position.length!==e.position.length)return!1;for(let t=0;t<s.position.length;t++)if(!gt(s.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yy=new he(B.comparator);function Ct(){return Yy}const bf=new he(B.comparator);function rr(...s){let e=bf;for(const t of s)e=e.insert(t.key,t);return e}function _f(s){let e=bf;return s.forEach((t,n)=>e=e.insert(t,n.overlayedDocument)),e}function Sn(){return fr()}function yf(){return fr()}function fr(){return new Mn(s=>s.toString(),(s,e)=>s.isEqual(e))}const Xy=new he(B.comparator),Jy=new Ae(B.comparator);function Z(...s){let e=Jy;for(const t of s)e=e.add(t);return e}const Zy=new Ae(J);function eE(){return Zy}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vo{constructor(e,t,n,r,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const r=new Map;return r.set(e,jr.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new vo(z.min(),r,new he(J),Ct(),Z())}}class jr{constructor(e,t,n,r,i){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new jr(n,t,Z(),Z(),Z())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const On="RemoteStore";class ET{constructor(e,t,n,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=i,this.Aa.Oo(o=>{n.enqueueAndForget(async()=>{Vn(this)&&(U(On,"Restarting streams for network reachability change."),await async function(l){const u=$(l);u.Ea.add(4),await Br(u),u.Ra.set("Unknown"),u.Ea.delete(4),await So(u)}(this))})}),this.Ra=new yT(n,r)}}async function So(s){if(Vn(s))for(const e of s.da)await e(!0)}async function Br(s){for(const e of s.da)await e(!1)}function zf(s,e){const t=$(s);t.Ia.has(e.targetId)||(t.Ia.set(e.targetId,e),Rc(t)?Sc(t):As(t).O_()&&Ic(t,e))}function vc(s,e){const t=$(s),n=As(t);t.Ia.delete(e),n.O_()&&Kf(t,e),t.Ia.size===0&&(n.O_()?n.L_():Vn(t)&&t.Ra.set("Unknown"))}function Ic(s,e){if(s.Va.Ue(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(z.min())>0){const t=s.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}As(s).Y_(e)}function Kf(s,e){s.Va.Ue(e),As(s).Z_(e)}function Sc(s){s.Va=new pE({getRemoteKeysForTarget:e=>s.remoteSyncer.getRemoteKeysForTarget(e),At:e=>s.Ia.get(e)||null,ht:()=>s.datastore.serializer.databaseId}),As(s).start(),s.Ra.ua()}function Rc(s){return Vn(s)&&!As(s).x_()&&s.Ia.size>0}function Vn(s){return $(s).Ea.size===0}function Wf(s){s.Va=void 0}async function TT(s){s.Ra.set("Online")}async function wT(s){s.Ia.forEach((e,t)=>{Ic(s,e)})}async function AT(s,e){Wf(s),Rc(s)?(s.Ra.ha(e),Sc(s)):s.Ra.set("Unknown")}async function vT(s,e,t){if(s.Ra.set("Online"),e instanceof xf&&e.state===2&&e.cause)try{await async function(r,i){const o=i.cause;for(const c of i.targetIds)r.Ia.has(c)&&(await r.remoteSyncer.rejectListen(c,o),r.Ia.delete(c),r.Va.removeTarget(c))}(s,e)}catch(n){U(On,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await to(s,n)}else if(e instanceof Di?s.Va.Ze(e):e instanceof kf?s.Va.st(e):s.Va.tt(e),!t.isEqual(z.min()))try{const n=await Hf(s.localStore);t.compareTo(n)>=0&&await function(i,o){const c=i.Va.Tt(o);return c.targetChanges.forEach((l,u)=>{if(l.resumeToken.approximateByteSize()>0){const d=i.Ia.get(u);d&&i.Ia.set(u,d.withResumeToken(l.resumeToken,o))}}),c.targetMismatches.forEach((l,u)=>{const d=i.Ia.get(l);if(!d)return;i.Ia.set(l,d.withResumeToken(Ne.EMPTY_BYTE_STRING,d.snapshotVersion)),Kf(i,l);const p=new $t(d.target,l,u,d.sequenceNumber);Ic(i,p)}),i.remoteSyncer.applyRemoteEvent(c)}(s,t)}catch(n){U(On,"Failed to raise snapshot:",n),await to(s,n)}}async function to(s,e,t){if(!Ts(e))throw e;s.Ea.add(1),await Br(s),s.Ra.set("Offline"),t||(t=()=>Hf(s.localStore)),s.asyncQueue.enqueueRetryable(async()=>{U(On,"Retrying IndexedDB access"),await t(),s.Ea.delete(1),await So(s)})}function $f(s,e){return e().catch(t=>to(s,t,e))}async function Ro(s){const e=$(s),t=an(e);let n=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:lc;for(;IT(e);)try{const r=await oT(e.localStore,n);if(r===null){e.Ta.length===0&&t.L_();break}n=r.batchId,ST(e,r)}catch(r){await to(e,r)}Qf(e)&&Yf(e)}function IT(s){return Vn(s)&&s.Ta.length<10}function ST(s,e){s.Ta.push(e);const t=an(s);t.O_()&&t.X_&&t.ea(e.mutations)}function Qf(s){return Vn(s)&&!an(s).x_()&&s.Ta.length>0}function Yf(s){an(s).start()}async function RT(s){an(s).ra()}async function PT(s){const e=an(s);for(const t of s.Ta)e.ea(t.mutations)}async function CT(s,e,t){const n=s.Ta.shift(),r=gc.from(n,e,t);await $f(s,()=>s.remoteSyncer.applySuccessfulWrite(r)),await Ro(s)}async function kT(s,e){e&&an(s).X_&&await async function(n,r){if(function(o){return Pf(o)&&o!==O.ABORTED}(r.code)){const i=n.Ta.shift();an(n).B_(),await $f(n,()=>n.remoteSyncer.rejectFailedWrite(i.batchId,r)),await Ro(n)}}(s,e),Qf(s)&&Yf(s)}async function dh(s,e){const t=$(s);t.asyncQueue.verifyOperationInProgress(),U(On,"RemoteStore received new credentials");const n=Vn(t);t.Ea.add(3),await Br(t),n&&t.Ra.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ea.delete(3),await So(t)}async function xT(s,e){const t=$(s);e?(t.Ea.delete(2),await So(t)):e||(t.Ea.add(2),await Br(t),t.Ra.set("Unknown"))}function As(s){return s.ma||(s.ma=function(t,n,r){const i=$(t);return i.sa(),new mT(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,r)}(s.datastore,s.asyncQueue,{Xo:TT.bind(null,s),t_:wT.bind(null,s),r_:AT.bind(null,s),H_:vT.bind(null,s)}),s.da.push(async e=>{e?(s.ma.B_(),Rc(s)?Sc(s):s.Ra.set("Unknown")):(await s.ma.stop(),Wf(s))})),s.ma}function an(s){return s.fa||(s.fa=function(t,n,r){const i=$(t);return i.sa(),new gT(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,r)}(s.datastore,s.asyncQueue,{Xo:()=>Promise.resolve(),t_:RT.bind(null,s),r_:kT.bind(null,s),ta:PT.bind(null,s),na:CT.bind(null,s)}),s.da.push(async e=>{e?(s.fa.B_(),await Ro(s)):(await s.fa.stop(),s.Ta.length>0&&(U(On,`Stopping write stream with ${s.Ta.length} pending writes`),s.Ta=[]))})),s.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cp{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ou(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ou(this.observer.error,e):Pt("Uncaught Error in snapshot listener:",e.toString()))}Nu(){this.muted=!0}Ou(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ut{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new F(O.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new F(O.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return J(this._lat,e._lat)||J(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:ut._jsonSchemaVersion}}static fromJSON(e){if(Vr(e,ut._jsonSchema))return new ut(e.latitude,e.longitude)}}ut._jsonSchemaVersion="firestore/geoPoint/1.0",ut._jsonSchema={type:Ee("string",ut._jsonSchemaVersion),latitude:Ee("number"),longitude:Ee("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ht{constructor(e){this._values=(e||[]).map(t=>t)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(n,r){if(n.length!==r.length)return!1;for(let i=0;i<n.length;++i)if(n[i]!==r[i])return!1;return!0}(this._values,e._values)}toJSON(){return{type:ht._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Vr(e,ht._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(t=>typeof t=="number"))return new ht(e.vectorValues);throw new F(O.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}ht._jsonSchemaVersion="firestore/vectorValue/1.0",ht._jsonSchema={type:Ee("string",ht._jsonSchemaVersion),vectorValues:Ee("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zc(s){s=ct(s,fe);const e=ct(s.firestore,Nn);return ow(Co(e),s._key).then(t=>Ep(e,s,t))}rs._jsonSchemaVersion="firestore/querySnapshot/1.0",rs._jsonSchema={type:Ee("string",rs._jsonSchemaVersion),bundleSource:Ee("string","QuerySnapshot"),bundleName:Ee("string"),bundle:Ee("string")};class Kc extends _p{constructor(e){super(),this.firestore=e}convertBytes(e){return new qe(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new fe(this.firestore,null,t)}}function ww(s,e,t){s=ct(s,fe);const n=ct(s.firestore,Nn),r=qc(s.converter,e,t);return yp(n,[Lc(Do(n),"setDoc",s._key,r,s.converter!==null,t).toMutation(s._key,Ue.none())])}function Aw(s,e){const t=ct(s.firestore,Nn),n=vs(s),r=qc(s.converter,e);return yp(t,[Lc(Do(s.firestore),"addDoc",n._key,r,s.converter!==null,{}).toMutation(n._key,Ue.exists(!1))]).then(()=>n)}function vw(s,...e){var l,u,d;s=Te(s);let t={includeMetadataChanges:!1,source:"default"},n=0;typeof e[n]!="object"||Ih(e[n])||(t=e[n++]);const r={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(Ih(e[n])){const p=e[n];e[n]=(l=p.next)==null?void 0:l.bind(p),e[n+1]=(u=p.error)==null?void 0:u.bind(p),e[n+2]=(d=p.complete)==null?void 0:d.bind(p)}let i,o,c;if(s instanceof fe)o=ct(s.firestore,Nn),c=yo(s._key.path),i={next:p=>{e[n]&&e[n](Ep(o,s,p))},error:e[n+1],complete:e[n+2]};else{const p=ct(s,dn);o=ct(p.firestore,Nn),c=p._query;const m=new Kc(o);i={next:y=>{e[n]&&e[n](new rs(o,m,p,y))},error:e[n+1],complete:e[n+2]},_w(s._query)}return function(m,y,P,x){const R=new cp(x),k=new Zf(y,R,P);return m.asyncQueue.enqueueAndForget(async()=>Xf(await Qa(m),k)),()=>{R.Nu(),m.asyncQueue.enqueueAndForget(async()=>Jf(await Qa(m),k))}}(Co(o),c,r,i)}function yp(s,e){return function(n,r){const i=new vt;return n.asyncQueue.enqueueAndForget(async()=>zT(await rw(n),r,i)),i.promise}(Co(s),e)}function Ep(s,e,t){const n=t.docs.get(e._key),r=new Kc(s);return new en(s,r,e._key,n,new es(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const io=new rc("@firebase/auth");function xw(s,...e){io.logLevel<=Y.WARN&&io.warn(`Auth (${_s}): ${s}`,...e)}function Ni(s,...e){io.logLevel<=Y.ERROR&&io.error(`Auth (${_s}): ${s}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function et(s,...e){throw Wc(s,...e)}function dt(s,...e){return Wc(s,...e)}function Ap(s,e,t){const n={...kw(),[e]:t};return new Lr("auth","Firebase",n).create(e,{appName:s.name})}function tn(s){return Ap(s,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Wc(s,...e){if(typeof s!="string"){const t=e[0],n=[...e.slice(1)];return n[0]&&(n[0].appName=s.name),s._errorFactory.create(t,...n)}return wp.create(s,...e)}function K(s,e,...t){if(!s)throw Wc(e,...t)}function Tt(s){const e="INTERNAL ASSERTION FAILED: "+s;throw Ni(e),new Error(e)}function kt(s,e){s||Tt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qr{constructor(e,t){this.shortDelay=e,this.longDelay=t,kt(t>e,"Short delay should be less than long delay!"),this.isMobile=Ub()||Hb()}get(){return Ow()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $c(s,e){kt(s.emulator,"Emulator should always be set here");const{url:t}=s.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gw(s,e){return fn(s,"POST","/v1/accounts:delete",e)}async function oo(s,e){return fn(s,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cr(s,e,t=!1){if(t)return e;try{return await e}catch(n){throw n instanceof Dt&&qw(n)&&s.auth.currentUser===s&&await s.auth.signOut(),n}}function qw({code:s}){return s==="auth/user-disabled"||s==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nh=new Map;function wt(s){kt(s instanceof Function,"Expected a class definition");let e=Nh.get(s);return e?(kt(e instanceof s,"Instance stored in cache mismatched with class"),e):(e=new s,Nh.set(s,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Li(s,e,t){return`firebase:${s}:${e}:${t}`}class os{constructor(e,t,n){this.persistence=e,this.auth=t,this.userKey=n;const{config:r,name:i}=this.auth;this.fullUserKey=Li(this.userKey,r.apiKey,i),this.fullPersistenceKey=Li("persistence",r.apiKey,i),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await oo(this.auth,{idToken:e}).catch(()=>{});return t?Je._fromGetAccountInfoResponse(this.auth,t,e):null}return Je._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,n="authUser"){if(!t.length)return new os(wt(Lh),e,n);const r=(await Promise.all(t.map(async u=>{if(await u._isAvailable())return u}))).filter(u=>u);let i=r[0]||wt(Lh);const o=Li(n,e.config.apiKey,e.name);let c=null;for(const u of t)try{const d=await u._get(o);if(d){let p;if(typeof d=="string"){const m=await oo(e,{idToken:d}).catch(()=>{});if(!m)break;p=await Je._fromGetAccountInfoResponse(e,m,d)}else p=Je._fromJSON(e,d);u!==i&&(c=p),i=u;break}}catch{}const l=r.filter(u=>u._shouldAllowMigration);return!i._shouldAllowMigration||!l.length?new os(i,e,n):(i=l[0],c&&await i._set(o,c.toJSON()),await Promise.all(t.map(async u=>{if(u!==i)try{await u._remove(o)}catch{}})),new os(i,e,n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hA(s,e){const t=oc(s,"auth");if(t.isInitialized()){const r=t.getImmediate(),i=t.getOptions();if(kn(i,e??{}))return r;et(r,"already-initialized")}return t.initialize({options:e})}function dA(s,e){const t=(e==null?void 0:e.persistence)||[],n=(Array.isArray(t)?t:[t]).map(wt);e!=null&&e.errorMap&&s._updateErrorMap(e.errorMap),s._initializeWithPersistence(n,e==null?void 0:e.popupRedirectResolver)}function fA(s,e,t){const n=Is(s);K(/^https?:\/\//.test(e),n,"invalid-emulator-scheme");const r=!1,i=jp(e),{host:o,port:c}=pA(e),l=c===null?"":`:${c}`,u={url:`${i}//${o}${l}/`},d=Object.freeze({host:o,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:r})});if(!n._canInitEmulator){K(n.config.emulator&&n.emulatorConfig,n,"emulator-config-failed"),K(kn(u,n.config.emulator)&&kn(d,n.emulatorConfig),n,"emulator-config-failed");return}n.config.emulator=u,n.emulatorConfig=d,n.settings.appVerificationDisabledForTesting=!0,bs(o)?(Od(`${i}//${o}${l}`),Nd("Auth",!0)):mA()}function jp(s){const e=s.indexOf(":");return e<0?"":s.substr(0,e+1)}function pA(s){const e=jp(s),t=/(\/\/)?([^?#/]+)/.exec(s.substr(e.length));if(!t)return{host:"",port:null};const n=t[2].split("@").pop()||"",r=/^(\[[^\]]+\])(:|$)/.exec(n);if(r){const i=r[1];return{host:i,port:jh(n.substr(i.length+1))}}else{const[i,o]=n.split(":");return{host:i,port:jh(o)}}}function jh(s){if(!s)return null;const e=Number(s);return isNaN(e)?null:e}function mA(){function s(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",s):s())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xc{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Tt("not implemented")}_getIdTokenResponse(e){return Tt("not implemented")}_linkToIdToken(e,t){return Tt("not implemented")}_getReauthenticationResolver(e){return Tt("not implemented")}}async function gA(s,e){return fn(s,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bA(s,e){return Mo(s,"POST","/v1/accounts:signInWithPassword",Fn(s,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _A(s,e){return Mo(s,"POST","/v1/accounts:signInWithEmailLink",Fn(s,e))}async function yA(s,e){return Mo(s,"POST","/v1/accounts:signInWithEmailLink",Fn(s,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function as(s,e){return Mo(s,"POST","/v1/accounts:signInWithIdp",Fn(s,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss{constructor(){this.providerId=Ss.PROVIDER_ID}static credential(e,t){return kr._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=Jc.parseLink(t);return K(n,"argument-error"),kr._fromEmailAndCode(e,n.code,n.tenantId)}}Ss.PROVIDER_ID="password";Ss.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Ss.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class co extends Dt{constructor(e,t,n,r){super(t.code,t.message),this.operationType=n,this.user=r,Object.setPrototypeOf(this,co.prototype),this.customData={appName:e.name,tenantId:e.tenantId??void 0,_serverResponse:t.customData._serverResponse,operationType:n}}static _fromErrorAndOperation(e,t,n,r){return new co(e,t,n,r)}}function Gp(s,e,t,n){return(e==="reauthenticate"?t._getReauthenticationResolver(s):t._getIdTokenResponse(s)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?co._fromErrorAndOperation(s,i,e,n):i})}async function AA(s,e,t=!1){const n=await Cr(s,e._linkToIdToken(s.auth,await s.getIdToken()),t);return ms._forOperation(s,"link",n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vA(s,e,t=!1){const{auth:n}=s;if(Xe(n.app))return Promise.reject(tn(n));const r="reauthenticate";try{const i=await Cr(s,Gp(n,r,e,s),t);K(i.idToken,n,"internal-error");const o=Qc(i.idToken);K(o,n,"internal-error");const{sub:c}=o;return K(s.uid===c,n,"user-mismatch"),ms._forOperation(s,r,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&et(n,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ft(){return window}function VA(s){ft().location.href=s}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $p(){return typeof ft().WorkerGlobalScope<"u"&&typeof ft().importScripts=="function"}async function FA(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function UA(){var s;return((s=navigator==null?void 0:navigator.serviceWorker)==null?void 0:s.controller)||null}function jA(){return $p()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JA="pendingRedirect",Mi=new Map;class ZA extends Jp{constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}async execute(){let e=Mi.get(this.auth._key());if(!e){try{const n=await ev(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(n)}catch(t){e=()=>Promise.reject(t)}Mi.set(this.auth._key(),e)}return this.bypassAuthState||Mi.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function ev(s,e){const t=sv(e),n=nv(s);if(!await n._isAvailable())return!1;const r=await n._get(t)==="true";return await n._remove(t),r}function tv(s,e){Mi.set(s._key(),e)}function nv(s){return wt(s._redirectPersistence)}function sv(s){return Li(JA,s.config.apiKey,s.name)}async function rv(s,e,t=!1){if(Xe(s.app))return Promise.reject(tn(s));const n=Is(s),r=WA(n,e),o=await new ZA(n,r,t).execute();return o&&!t&&(delete o.user._redirectEventId,await n._persistUserIfCurrent(o.user),await n._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fv=new qr(3e4,6e4);function zh(){const s=ft().___jsl;if(s!=null&&s.H){for(const e of Object.keys(s.H))if(s.H[e].r=s.H[e].r||[],s.H[e].L=s.H[e].L||[],s.H[e].r=[...s.H[e].L],s.CP)for(let t=0;t<s.CP.length;t++)s.CP[t]=null}}function pv(s){return new Promise((e,t)=>{var r,i,o;function n(){zh(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{zh(),t(dt(s,"network-request-failed"))},timeout:fv.get()})}if((i=(r=ft().gapi)==null?void 0:r.iframes)!=null&&i.Iframe)e(gapi.iframes.getContext());else if((o=ft().gapi)!=null&&o.load)n();else{const c=oA("iframefcb");return ft()[c]=()=>{gapi.load?n():t(dt(s,"network-request-failed"))},Fp(`${iA()}?onload=${c}`).catch(l=>t(l))}}).catch(e=>{throw Vi=null,e})}let Vi=null;function mv(s){return Vi=Vi||pv(s),Vi}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Aa="webStorageSupport";class Nv{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Wp,this._completeRedirectFn=rv,this._overrideRedirectResult=tv}async _openPopup(e,t,n,r){var o;kt((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const i=await Wh(e,t,n,Xa(),r);return Pv(e,i,Zc())}async _openRedirect(e,t,n,r){await this._originValidation(e);const i=await Wh(e,t,n,Xa(),r);return VA(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:r,promise:i}=this.eventManagers[t];return r?Promise.resolve(r):(kt(i,"If manager is not set, promise should be"),i)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch(()=>{delete this.eventManagers[t]}),n}async initAndGetManager(e){const t=await wv(e),n=new ov(e);return t.register("authEvent",r=>(K(r==null?void 0:r.authEvent,e,"invalid-auth-event"),{status:n.onEvent(r.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Aa,{type:Aa},r=>{var o;const i=(o=r==null?void 0:r[0])==null?void 0:o[Aa];i!==void 0&&t(!!i),et(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=hv(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Mp()||kp()||Yc()}}const Lv=Nv;var $h="@firebase/auth",Qh="1.11.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const Uv=5*60,jv=Dd("authIdTokenMaxAge")||Uv;let Yh=null;const Bv=s=>async e=>{const t=e&&await e.getIdTokenResult(),n=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>jv)return;const r=t==null?void 0:t.token;Yh!==r&&(Yh=r,await fetch(s,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function Gv(s=Fd()){const e=oc(s,"auth");if(e.isInitialized())return e.getImmediate();const t=hA(s,{popupRedirectResolver:Lv,persistence:[KA,NA,Wp]}),n=Dd("authTokenSyncURL");if(n&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(n,location.origin);if(location.origin===i.origin){const o=Bv(i.toString());CA(t,o,()=>o(t.currentUser)),PA(t,c=>o(c))}}const r=kd("auth");return r&&fA(t,`http://${r}`),t}function Hv(){var s;return((s=document.getElementsByTagName("head"))==null?void 0:s[0])??document}sA({loadJS(s){return new Promise((e,t)=>{const n=document.createElement("script");n.setAttribute("src",s),n.onload=e,n.onerror=r=>{const i=dt("internal-error");i.customData=r,t(i)},n.type="text/javascript",n.charset="UTF-8",Hv().appendChild(n)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Fv("Browser");const qv={apiKey:"AIzaSyAfsWy2TC4reH-C2B_SuaDgO6vf4GgzEjc",authDomain:"moon-73219.firebaseapp.com",projectId:"moon-73219",appId:"1:236058396603:web:96d8a55306db8d7468e69e"},em=Vd(qv),ln=cw(em),br=Gv(em),Rn=Cw;async function tm(){if(br.currentUser)return br.currentUser;const s=prompt("ADMIN email"),e=prompt("ADMIN password");if(!s||!e)throw new Error("로그인이 필요합니다");const{user:t}=await RA(br,s,e);return t}function zv(s){return kA(br,s)}async function Kv(){await xA(br)}function Xh(s){if(!s)return null;if(typeof(s==null?void 0:s.toDate)=="function")return s.toDate();if(s instanceof Date)return isNaN(s)?null:s;const e=new Date(s);return isNaN(e)?null:e}function Jh(s,e){if(!s||!e)return null;const t=Math.round((e-s)/36e5);return Math.max(0,t)}function Wv(s,e,t){const n=e.bigStageDurations||{},r=e.bigStageStartedAt||{},i=String(s+1),o=n[i];if(o!=null&&!Number.isNaN(Number(o)))return`~${Number(o)}h`;const c=Xh(r[String(s)]),l=Xh(r[i]);if(c&&l){const u=Jh(c,l);return u!=null?`~${u}h`:"–"}if(s===Number(e.big)&&c){const u=Jh(c,t);return u!=null?`~${u}h`:"–"}return"–"}function $v(s,e,t){const n=Wv(s,e,t);return`
  ...
  `,tl(s,e,t))}function tl(s,e,t){const n=document.querySelector(s);if(!n)return;const r=n.querySelector("#mpv2-stage-grid");if(!r)return;const i=e.find(u=>u.serverId===t)||e[0];if(!i){r.innerHTML="";return}const o=new Date,c=[],l=Or;for(let u=1;u<=l;u++)c.push($v(u,i,o));r.innerHTML=c.join("")}let nm=!1;const Zh=document.getElementById("lp-admin-login"),ed=document.getElementById("lp-admin-logout"),td=document.getElementById("lp-admin-status");Zh&&Zh.addEventListener("click",async()=>{try{await tm()}catch(s){alert(s.message)}});ed&&ed.addEventListener("click",async()=>{await Kv()});zv(async s=>{var t;td&&(td.textContent=s?`관리자: ${s.email}`:"로그아웃");let e=!1;if(s)try{const n=await zc(vs(ln,"roles",s.uid));e=n.exists()&&((t=n.data())==null?void 0:t.admin)===!0}catch(n){e=!1,console.warn("[roles] read failed:",n)}nm=e,document.documentElement.classList.toggle("lp-admin-auth",e)});const re={tabs:document.querySelectorAll("[data-lp-tab]"),subTitle:document.getElementById("lp-subtitle"),topTitle:document.getElementById("lp-top-title"),topLoc:document.getElementById("lp-top-location"),topDistBar:document.getElementById("lp-top-distance-bar"),miniUpd:document.getElementById("lp-updated-mini"),cmList:document.getElementById("lp-comments"),cmForm:document.getElementById("lp-comment-form"),cmInput:document.getElementById("lp-comment-input"),cmScope:document.getElementById("lp-comment-scope"),btnDec:document.getElementById("lp-dec"),btnInc:document.getElementById("lp-inc")};let At="tonbery",Qn=null;const sm=s=>Math.max(0,Math.min(1,s)),Yv=(s,e)=>{var t;return(t=s==null?void 0:s.style)==null?void 0:t.setProperty("--pct",sm(e))},Xv=s=>String(s).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;"),rm=s=>typeof(s==null?void 0:s.toDate)=="function"?s.toDate():s?new Date(s):null;function Jv(s,e){return`${Number(s)}/${Or}-${Number(e)}`}async function gs(){return await Promise.all(wd.map(async e=>{const t=vs(ln,"progress",e),n=await zc(t);if(!n.exists())return{serverId:e,title:e,big:1,small:0,bigStageStartedAt:{},bigStageDurations:{},updated_at:null};const r=n.data();return{serverId:e,title:r.title??e,big:Number(r.big??1),small:Number(r.small??0),bigStageStartedAt:r.bigStageStartedAt||{},bigStageDurations:r.bigStageDurations||{},updated_at:r.updated_at??null}}))}async function xr(s,e=null){const t=s;let n=e==null?void 0:e[t];if(!n){const i=vs(ln,"progress",t),o=await zc(i),c=o.exists()?o.data():null;n={serverId:t,title:(c==null?void 0:c.title)??t,big:Number((c==null?void 0:c.big)??1),small:Number((c==null?void 0:c.small)??0),bigStageStartedAt:(c==null?void 0:c.bigStageStartedAt)||{},bigStageDurations:(c==null?void 0:c.bigStageDurations)||{},updated_at:(c==null?void 0:c.updated_at)??null}}re.topTitle&&(re.topTitle.textContent=n.title||t),re.topLoc&&(re.topLoc.textContent=Jv(n.big,n.small));const r=sm((n.small??0)/vn);if(Yv(re.topDistBar,r),re.miniUpd){const i=rm(n.updated_at);re.miniUpd.textContent=i?`수정시각: ${Ad(i)}`:""}return{id:t,data:n,pct:r}}async function ec(s){var i;if(await tm(),!nm){alert("관리자 권한이 필요합니다.");return}const e=At,t=vs(ln,"progress",e);await Pw(ln,async o=>{const l=(await o.get(t)).data()||{};let u=Number(l.big??1),d=Number(l.small??0);const p=u,m=d;d+=s,d>vn?u<Or?(u+=1,d=0):d=vn:d<0&&(u>1?(u-=1,d=vn):d=0);const y={big:u,small:d,updated_at:Rn()};if(u===p+1&&m===vn&&d===0){const x=l.bigStageStartedAt||{},R=l.bigStageDurations||{},k=new Date,D=rm(x[String(p)]),N={...R};if(D){const G=Math.max(0,Math.round((k-D)/36e5)),q=String(u);N[q]==null&&(N[q]=G)}const M={...x};M[String(u)]||(M[String(u)]=Rn()),M[1]||(M[1]=Rn()),y.bigStageDurations=N,y.bigStageStartedAt=M}else{const x=l.bigStageStartedAt||{};x[1]||(y.bigStageStartedAt={...x,1:Rn()})}o.set(t,y,{merge:!0})});const n=await gs(),r=Object.fromEntries(n.map(o=>[o.serverId,o]));await xr(e,r),tl("#mpv2-progress-root",n,e),(i=window.Route)==null||i.setAll(n),window.dispatchEvent(new Event("lp-progress-updated"))}function Zv(s){const e=re.cmList;if(!e)return;if(!(s!=null&&s.length)){e.innerHTML='<li class="lp-comment" style="opacity:.7">아직 댓글이 없습니다.</li>';return}const t=s.map(n=>{var d;const r=n.data(),i=(r.server_id||"-").toString(),o=(d=r.created_at)!=null&&d.toDate?r.created_at.toDate():null,c=o?Ad(o):"-",l=(r.content??"").toString();return`
      <li class="lp-comment">
        <span class="lp-cm-tag">${(i[0]||"?").toUpperCase()}</span>
        <div>${Xv(l)}</div>
        <time>${c}</time>
      </li>
    `}).join("");e.innerHTML=t}function _r(s="all"){if(!re.cmList)return()=>{};typeof Qn=="function"&&(Qn(),Qn=null);const e=hp(ln,"comments"),t=s==="all"?Sh(e,Rh("created_at","desc"),Ph(30)):Sh(e,yw("server_id","==",s),Rh("created_at","desc"),Ph(30));return Qn=vw(t,n=>Zv(n.docs),n=>{console.error("[comments:onSnapshot]",n),re.cmList.innerHTML='<li class="lp-comment" style="opacity:.7">댓글을 불러오지 못했습니다.</li>'}),()=>{Qn&&Qn()}}async function nl(s,e){const t=(e??"").trim();if(!t.length)return;if(t.length>500){alert("댓글은 최대 500자까지 가능합니다.");return}const n=s&&s!=="all"?s:At;await Aw(hp(ln,"comments"),{server_id:n,content:t,created_at:Rn()})}function nd(s){var e;At=s,(e=re.tabs)==null||e.forEach(t=>{var r;const n=((r=t==null?void 0:t.dataset)==null?void 0:r.lpTab)===s;t.classList.toggle("is-active",n),t.classList.toggle("on",n),t.setAttribute("aria-current",n?"true":"false")})}async function im(s=null){var e;(e=re.tabs)==null||e.forEach(t=>{t.addEventListener("click",async n=>{var c,l,u;const r=(l=(c=n.currentTarget)==null?void 0:c.dataset)==null?void 0:l.lpTab;if(!r||!wd.includes(r))return;nd(r);const i=await gs(),o=Object.fromEntries(i.map(d=>[d.serverId,d]));await xr(r,o),tl("#mpv2-progress-root",i,r),(u=window.Route)==null||u.setAll(i),re.cmScope&&(re.cmScope.value=r),_r(r)},{passive:!0})}),re.btnDec&&re.btnDec.addEventListener("click",()=>ec(-1)),re.btnInc&&re.btnInc.addEventListener("click",()=>ec(1)),re.cmScope&&re.cmScope.addEventListener("change",()=>{const t=re.cmScope.value||"all";_r(t)}),re.cmForm&&re.cmInput&&re.cmForm.addEventListener("submit",async t=>{var i;t.preventDefault();const n=((i=re.cmScope)==null?void 0:i.value)||"all",r=re.cmInput.value.trim();if(r)try{await nl(n,r),re.cmInput.value=""}catch{alert("댓글 저장 실패")}});try{nd(At);const t=s||await gs(),n=Object.fromEntries(t.map(r=>[r.serverId,r]));await xr(At,n),re.cmScope&&(re.cmScope.value=At),_r(At)}catch(t){console.error("[LP:init]",t)}}let sd=!1;async function om(){var t;if(sd)return;sd=!0;const s=await gs();Qv("#mpv2-progress-root",s,At),(t=window.Route)==null||t.setAll(s,{animate:!1});const e=document.querySelector("#server-progress-old");return e&&(e.innerHTML=""),im(s)}async function am(s="tonbery",{title:e,big:t=1,small:n=0}={}){await ww(vs(ln,"progress",s),{title:e??s[0].toUpperCase()+s.slice(1),big:t,small:n,bigStageStartedAt:{[String(t)]:Rn()},bigStageDurations:{},updated_at:Rn()},{merge:!0})}window.LP={seed:am,fetchProgressAll:gs,refreshTop:xr,listenComments:_r,postComment:nl,adjustProgress:ec,get active(){return At}};const rd=Object.freeze(Object.defineProperty({__proto__:null,fetchProgressAll:gs,initLP:im,listenComments:_r,mountLP:om,postComment:nl,refreshTop:xr,seedProgress:am},Symbol.toStringTag,{value:"Module"}));om();const eI=document.getElementById("goCanvas"),tI=document.getElementById("goLicense");eI.href=new URL("../licenses/CANVAS.html",location.href).href;tI.href=new URL("../licenses/license.html",location.href).href;const jo=document.getElementById("homeDd"),sl=document.getElementById("homeToggle");function rl(){jo.classList.remove("open"),sl.setAttribute("aria-expanded","false")}function nI(){jo.classList.add("open"),sl.setAttribute("aria-expanded","true")}sl.addEventListener("click",s=>{s.stopPropagation(),jo.classList.contains("open")?rl():nI()});document.addEventListener("click",s=>{jo.contains(s.target)||rl()});document.addEventListener("keydown",s=>{s.key==="Escape"&&rl()});
